  ...
  return (
    <div id="about" className="">
      ...
      <h2 className="px-10 py-10 text-5xl text-center font-medium transition ease-in-out delay-150 duration-300">
        ...
        <p className="px-10 py-0 text-left text-white text-lg font-medium">
          Our mission is: to leverage our skills and knowledge in computer
          science to support and empower farmers. We firmly believe that the
          fusion of cutting-edge technology with the primary sector, and
          backbone of our nation - Agriculture, can revolutionize the sector.
          ...
          >
            <Card.Body className=" flex flex-col items-center justify-items-center">
              ...
              <div className="flex">
                {" "}
                <button
                  class="bg-gray-800 text-white shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                  type="button"
                >
            ...
            <Card.Body className=" flex flex-col items-center justify-items-center">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  type="button"
                >
                  <a href="https://twitter.com/praveenpatro9">
                    <i class="fab fa-twitter" />
                  </a>
                </button>
                <button
                  ...
                  type="button"
                >
                  <a href="https://www.linkedin.com/in/praveen-chandra-patro-1a6a5a257/">
                    {" "}
                    <i class="fab fa-linkedin-in" />
                  </a>
                </button>
                <button
                  ...
                  type="button"
                >
                  <a href="https://github.com/praveen-p09/">
                    <i class="fab fa-github" />
                  </a>
                </button>
              </div>
