...
const Section4 = (props) => {
    return (
        <div className="mx-0 my-0 section4 h-screen flex flex-col">
            ...
            <div className="sec4-left w-1/2 p-3 items-center justify-items-center"><img className="h-1/2 w-2/3 rotate-45 transition ease-in-out delay-300 hover:-translate-y-1 hover:scale-110 duration-300" src={require("./images/Innovations.png")} alt="innovation-bulb" /></div>
